...
| 6 | Phase 16 (add-on database submission) + Phase 18 (agent-side Playnite library reader + `agent-ui` chip) + Phase 19 (`agent-ui` "Playnite plugin" suggest/install card) | ⏳ Not started — Phases 18-19 added 2026-09-16, merged into Group 6 the same day |
