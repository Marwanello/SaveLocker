...
- **Decky conflict resolution (phases 0–14).** Phases 0–9 plus Groups 4–6 shipped, Phase 10/11 hardware-verified; phases 13–14 remain open → `tasks/conflict-resolution-ui/plan.md`.
