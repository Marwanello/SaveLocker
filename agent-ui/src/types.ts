...
export type AgentAppearance = components['schemas']['AgentAppearanceDto']
...
export type PlaynitePluginCardStatus = components['schemas']['PlaynitePluginCardStatusDto']
export type PlaynitePluginStatus = components['schemas']['PlaynitePluginStatusDto']
