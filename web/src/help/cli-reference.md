...
>
> To stop the agent preparing updates on its own, set `"AutoUpdate": false` in `~/.local/share/SaveLocker/config.json`. It keeps checking, so you still hear that you are behind.
