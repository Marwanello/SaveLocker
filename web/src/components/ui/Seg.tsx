...
export function Seg<T extends string>({ value, options, onChange, className = '', disabled = false, ...rest }: Props<T>) {
  return (
    <div
      role="group"
    ...
    >
      {options.map(o => (
        <button
          ...
          className={`text-[12.5px] font-semibold px-[15px] py-[7px] rounded-full border-0 cursor-pointer disabled:cursor-default
