...
The Obsidian vault is at `SaveLocker/` (repo root). Content lives under `SaveLocker/docs/` — articles at the top level, one folder per backlog item under `docs/tasks/`, write-ups under `docs/logs/`.
