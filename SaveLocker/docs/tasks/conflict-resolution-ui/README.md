...
2026-08-30 from `SaveLocker/logs/` — now `SaveLocker/docs/logs/` — and repo-root `docs/design/` — a stub at the old `logs/` path
...
**Once every phase in `plan.md` ships**, move this whole folder to `SaveLocker/docs/logs/` with a date
